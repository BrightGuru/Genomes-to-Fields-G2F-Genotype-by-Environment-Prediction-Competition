...
####Genomic data 
Geno_data = dt.fread("/usr/users/osatohanmwen/G2F_competition_2024/Genotype_True.csv")
...
XGBr_clf = lgb.LGBMRegressor(random_state = 99)
...
Data_OP.to_csv("G2F_comp_LGBfinal20cv.csv",index=False)
